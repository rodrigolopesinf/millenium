...
(function (c) {
    function o(d, a, b) {
        var e, f, g = a.options.chart.options3d, h = !1; b ? (h = a.inverted, b = a.plotWidth / 2, a = a.plotHeight / 2, e = g.depth / 2, f = z(g.depth, 1) * z(g.viewDistance, 0)) : (b = a.plotLeft + a.plotWidth / 2, a = a.plotTop + a.plotHeight / 2, e = g.depth / 2, f = z(g.depth, 1) * z(g.viewDistance, 0)); var j = [], i = b, k = a, v = e, q = f, b = w * (h ? g.beta : -g.beta), g = w * (h ? -g.alpha : g.alpha), p = l(b), s = m(b), t = l(g), u = m(g), x, C, r, o, n, y; c.each(d, function (a) {
            x = (h ? a.y : a.x) - i; C = (h ? a.x : a.y) - k; r = (a.z || 0) - v; o = s * x - p * r; n = -p * t * x - s * t * r + u * C; y = p * u * x + s * u * r + t * C; q > 0 &&
            q < Number.POSITIVE_INFINITY && (o *= q / (y + v + q), n *= q / (y + v + q)); o += i; n += k; y += v; j.push({ x: h ? n : o, y: h ? o : n, z: y })
        }); return j
    } function n(d) { return d !== void 0 && d !== null } function E(d) { var a = 0, b, e; for (b = 0; b < d.length; b++) e = (b + 1) % d.length, a += d[b].x * d[e].y - d[e].x * d[b].y; return a / 2 } function D(d) { var a = 0, b; for (b = 0; b < d.length; b++) a += d[b].z; return d.length ? a / d.length : 0 } function r(d, a, b, e, f, g, c, j) {
        var i = []; return g > f && g - f > p / 2 + 1.0E-4 ? (i = i.concat(r(d, a, b, e, f, f + p / 2, c, j)), i = i.concat(r(d, a, b, e, f + p / 2, g, c, j))) : g < f && f - g > p / 2 + 1.0E-4 ?
        ...
        if (this.chart.is3d()) {
            var a = this.chart.options.plotOptions.column.grouping; if (a !== void 0 && !a && this.group.zIndex !== void 0 && !this.zIndexSet) this.group.attr({ zIndex: this.group.zIndex * 10 }), this.zIndexSet = !0; var b = this.options, e = this.options.states; this.borderWidth = b.borderWidth = n(b.edgeWidth) ? b.edgeWidth :
            1; c.each(this.data, function (a) { if (a.y !== null) a = a.pointAttr, this.borderColor = c.pick(b.edgeColor, a[""].fill), a[""].stroke = this.borderColor, a.hover.stroke = c.pick(e.hover.edgeColor, this.borderColor), a.select.stroke = c.pick(e.select.edgeColor, this.borderColor) })
        } d.apply(this, [].slice.call(arguments, 1))
    } var p = Math.PI, w = p / 180, l = Math.sin, m = Math.cos, z = c.pick, G = Math.round; c.perspective = o; var A = 4 * (Math.sqrt(2) - 1) / 3 / (p / 2); c.SVGRenderer.prototype.toLinePath = function (d, a) {
        var b = []; c.each(d, function (a) {
            b.push("L",
            a.x, a.y)
        }); d.length && (b[0] = "M", a && b.push("Z")); return b
        ...
        var a = this.g(), d = this.cuboidPath(d); a.front = this.path(d[0]).attr({ zIndex: d[3], "stroke-linejoin": "round" }).add(a); a.top = this.path(d[1]).attr({ zIndex: d[4], "stroke-linejoin": "round" }).add(a); a.side = this.path(d[2]).attr({ zIndex: d[5], "stroke-linejoin": "round" }).add(a); a.fillSetter = function (a) {
            var d = c.Color(a).brighten(0.1).get(), f = c.Color(a).brighten(-0.1).get(); this.front.attr({ fill: a }); this.top.attr({ fill: d });
            this.side.attr({ fill: f }); this.color = a; return this
        }; a.opacitySetter = function (a) { this.front.attr({ opacity: a }); this.top.attr({ opacity: a }); this.side.attr({ opacity: a }); return this }; a.attr = function (a) { a.shapeArgs || n(a.x) ? (a = this.renderer.cuboidPath(a.shapeArgs || a), this.front.attr({ d: a[0], zIndex: a[3] }), this.top.attr({ d: a[1], zIndex: a[4] }), this.side.attr({ d: a[2], zIndex: a[5] })) : c.SVGElement.prototype.attr.call(this, a); return this }; a.animate = function (a, d, f) {
        ...
        var a = d.x, b = d.y, e = d.z, f = d.height, g = d.width, h = d.depth, j = c.map, i = [{
            x: a, y: b,
            z: e
        }, { x: a + g, y: b, z: e }, { x: a + g, y: b + f, z: e }, { x: a, y: b + f, z: e }, { x: a, y: b + f, z: e + h }, { x: a + g, y: b + f, z: e + h }, { x: a + g, y: b, z: e + h }, { x: a, y: b, z: e + h }], i = o(i, c.charts[this.chartIndex], d.insidePlotArea), b = function (a, b) { a = j(a, function (a) { return i[a] }); b = j(b, function (a) { return i[a] }); return E(a) < 0 ? a : E(b) < 0 ? b : [] }, d = b([3, 2, 1, 0], [7, 6, 5, 4]), a = b([1, 6, 7, 0], [4, 5, 2, 3]), b = b([1, 2, 5, 6], [0, 7, 4, 3]); return [this.toLinePath(d, !0), this.toLinePath(a, !0), this.toLinePath(b, !0), D(d), D(a), D(b)]
    ...
    function (d) {
        ...
        x, n)), i = i.concat(["Z"]), k = ["M", a + u * v, b + h * q], k = k.concat(r(a, b, u, h, e, c, 0, 0)), k = k.concat(["L", a + u * m(c) + x, b + h * l(c) + n]), k = k.concat(r(a, b, u, h, c, e, x, n)), k = k.concat(["Z"]), v = ["M", a + s * v, b + t * q, "L", a + s * v + x, b + t * q + n, "L", a + u * v + x, b + h * q + n, "L", a + u * v, b + h * q, "Z"], a = ["M", a + s * d, b + t * o, "L", a + s * d + x, b + t * o + n, "L", a + u * d + x, b + h * o + n, "L", a + u * d, b + h * o, "Z"], b = l((e + c) / 2), e = l(e), c = l(c); return { top: j, zTop: g, out: i, zOut: Math.max(b, e, c) * g, inn: k, zInn: Math.max(b, e, c) * g, side1: v, zSide1: e * g * 0.99, side2: a, zSide2: c * g * 0.99 }
    ...
    "init", function (d) { var a = arguments; if (a[1].is3d()) a[2].tickWidth = c.pick(a[2].tickWidth, 0), a[2].gridLineWidth = c.pick(a[2].gridLineWidth, 1); d.apply(this, [].slice.call(arguments, 1)) }); c.wrap(c.Axis.prototype, "render", function (d) {
        d.apply(this, [].slice.call(arguments, 1)); if (this.chart.is3d()) {
            var a = this.chart, b = a.renderer, c = a.options.chart.options3d, f = c.frame, g = f.bottom, h = f.back, f = f.side, j = c.depth, i = this.height, k = this.width, l = this.left, q = this.top; this.horiz ? (this.axisLine && this.axisLine.hide(), h = {
                x: l,
                ...
                x: (a.yAxis[0].opposite ?
                    k : 0) + l - f.size, y: q, z: 0, width: f.size, height: i + g.size, depth: j + h.size, insidePlotArea: !1
        ...
        var a = c.apply(this, [].slice.call(arguments, 1)); if (!this.chart.is3d()) return a; if (a === null) return a; var b = this.chart.options.chart.options3d.depth, a = [{ x: a[1], y: a[2], z: this.horiz || this.opposite ? b : 0 }, { x: a[1], y: a[2], z: b }, {
            x: a[4], y: a[5],
            z: b
        }, { x: a[4], y: a[5], z: this.horiz || this.opposite ? 0 : b }], a = o(a, this.chart, !1); return a = this.chart.renderer.toLinePath(a, !1)
        ...
        a = [{ x: a[1], y: a[2], z: 0 }, { x: a[4], y: a[5], z: 0 }]; a = o(a, this.axis.chart, !1); return a = ["M", a[0].x, a[0].y, "L", a[1].x, a[1].y]
    }); c.wrap(c.Tick.prototype, "getLabelPosition", function (c) { var a = c.apply(this, [].slice.call(arguments, 1)); if (!this.axis.chart.is3d()) return a; a = o([{ x: a.x, y: a.y, z: 0 }], this.axis.chart, !1)[0]; a.x -= !this.axis.horiz && this.axis.opposite ? this.axis.transA : 0; return a }); c.wrap(c.Axis.prototype, "drawCrosshair", function (c) {
        ...
        d.apply(this, [].slice.call(arguments, 1)); if (this.chart.is3d()) {
            var a = this.chart, b = this.options, e = b.depth || 25, f = (b.stacking ? b.stack || 0 : this._i) * (e + (b.groupZPadding || 1)); b.grouping !== !1 && (f = 0); f += b.groupZPadding || 1; c.each(this.data, function (b) {
                if (b.y !== null) {
                    var c = b.shapeArgs, d = b.tooltipPos; b.shapeType = "cuboid"; c.z = f; c.depth = e; c.insidePlotArea = !0; d = o([{ x: d[0], y: d[1], z: f }],
        ...
        c.apply(this, [].slice.call(arguments, 1)); if (this.chart.is3d()) {
            var a = this.options, b = a.grouping, e = a.stacking, f = 0; if (b === void 0 || b) { b = this.chart.retrieveStacks(e); e = a.stack || 0; for (f = 0; f < b[e].series.length; f++) if (b[e].series[f] === this) break; f = b.totalStacks * 10 - 10 * (b.totalStacks - b[e].position) - f } a.zIndex =
            f
        }
    ...
    { type: "cylinder" }); c.seriesTypes.cylinder = B; c.wrap(c.seriesTypes.cylinder.prototype, "translate", function (d) {
        d.apply(this, [].slice.call(arguments, 1)); if (this.chart.is3d()) {
            var a = this.chart, b = a.options, e = b.plotOptions.cylinder, b = b.chart.options3d, f = e.depth || 0, g = { x: a.inverted ? a.plotHeight / 2 : a.plotWidth / 2, y: a.inverted ? a.plotWidth / 2 : a.plotHeight / 2, z: b.depth, vd: b.viewDistance }, h = b.alpha, j = e.stacking ? (this.options.stack || 0) * f : this._i * f; j += f / 2; e.grouping !== !1 && (j = 0); c.each(this.data, function (a) {
                var b = a.shapeArgs;
                a.shapeType = "arc3d"; b.x += f / 2; b.z = j; b.start = 0; b.end = 2 * p; b.r = f * 0.95; b.innerR = 0; b.depth = b.height * (1 / l((90 - h) * w)) - j; b.alpha = 90 - h; b.beta = 0; b.origin = g
            })
        }
        ...
        d.apply(this, [].slice.call(arguments, 1)); if (this.chart.is3d()) {
            var a = this, b = a.chart, e = a.options, f = e.depth || 0, g = b.options.chart.options3d, h = { x: b.plotWidth / 2, y: b.plotHeight / 2, z: g.depth }, j = g.alpha, i = g.beta, k = e.stacking ? (e.stack || 0) * f : a._i * f; k += f / 2; e.grouping !== !1 && (k = 0); c.each(a.data, function (b) {
                b.shapeType =
                "arc3d"; var c = b.shapeArgs; if (b.y) c.z = k, c.depth = f * 0.75, c.origin = h, c.alpha = j, c.beta = i, c = (c.end + c.start) / 2, b.slicedTranslation = { translateX: G(m(c) * a.options.slicedOffset * m(j * w)), translateY: G(l(c) * a.options.slicedOffset * m(j * w)) }
            })
        }
        ...
        if (this.chart.is3d()) {
            var a = this; c.each(a.data, function (b) {
                var c = b.shapeArgs,
                d = c.r, g = c.depth, h = (c.alpha || a.chart.options.chart.options3d.alpha) * w, c = (c.start + c.end) / 2, b = b.labelPos; b[1] += -d * (1 - m(h)) * l(c) + (l(c) > 0 ? l(h) * g : 0); b[3] += -d * (1 - m(h)) * l(c) + (l(c) > 0 ? l(h) * g : 0); b[5] += -d * (1 - m(h)) * l(c) + (l(c) > 0 ? l(h) * g : 0)
            })
        } d.apply(this, [].slice.call(arguments, 1))
